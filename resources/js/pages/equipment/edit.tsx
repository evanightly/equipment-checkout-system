...
export default function EditEquipment({ equipment, divisions, statuses }: Props) {
    const [imagePreview, setImagePreview] = useState<string | null>(equipment.image_path ? `/storage/${equipment.image_path}` : null);
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        division_id: equipment.division_id ? equipment.division_id.toString() : '',
        image: null as File | null,
        notes: equipment.notes || '',
        is_available_for_borrowing: equipment.is_available_for_borrowing as boolean,
    });
                        ...
                        <form className='space-y-6' onSubmit={handleSubmit}>
                            ...
                            <div className='grid gap-4 md:grid-cols-2'>
                                <div className='space-y-2'>
                                    ...
                                    <Select onValueChange={(value) => setData('status', value as Equipment['status'])} value={data.status}>
                                        <SelectTrigger>
                            ...
                            <div className='flex items-center space-x-4 pt-4'>
                                ...
                                <Button asChild type='button' variant='outline'>
                                    <Link href={route('equipment.show', equipment.id)}>View Equipment</Link>
                                </Button>
                                <Button asChild type='button' variant='outline'>
